...
//        dayLoopView.setTextSize(25);
    ...
    private String dateFormatChange(String strDate){

        SimpleDateFormat input = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH);
        SimpleDateFormat output = new SimpleDateFormat(dateFormat, Locale.ENGLISH);
        try {
        ...
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                if(dateFormat != null && !dateFormat.isEmpty()) {
                    String date = dateFormatChange(sb.toString());
                    sb = new StringBuffer();
